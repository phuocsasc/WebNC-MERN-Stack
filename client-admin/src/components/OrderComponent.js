      ...
      return (
        ...
        >
          ...
          <td className="p-4 flex items-center">
            {item.status === 'PENDING' ? <Clock className="text-yellow-500" /> : item.status === 'APPROVED' ? <CheckCircle className="text-green-500" /> : <XCircle className="text-red-500" />}
    ...
    return (
      <div className="p-6 bg-gray-100 min-h-screen content">
        ...
        {this.state.order && (
          ...
          >
            <h2 className="text-3xl font-bold mb-6 text-center text-gray-700">Order Detail</h2>
